      ...
      <main className="welcome-main">
        <section className="welcome-hero animate-float">
          <div className="welcome-hero-text">
            ...
            <p>
              Build confidence with dynamic practice rooms, interactive interviewers, and
              insights tailored to the role you want next. Interview Bot adapts to your
              strengths, closing gaps with precision.
            </p>
